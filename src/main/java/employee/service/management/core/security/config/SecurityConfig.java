...
import employee.service.management.core.security.service.JwtAuthenticationFilter;
                ...
                .authorizeHttpRequests(
                        authorize ->
                                authorize
                                        ...
                                        .requestMatchers(HttpMethod.POST, "/api/v1/employee").hasRole("USER")
                                        .requestMatchers(HttpMethod.PUT, "/api/v1/employee/{id}").hasRole("USER")
                                        .requestMatchers(HttpMethod.DELETE, "/api/v1/employee/{id}").hasRole("ADMIN")
